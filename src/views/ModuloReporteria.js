...
const ModuloReporteria = () => {
  const navigate = useNavigate();

  return (
    <div className="flex flex-col h-screen bg-gray-200">
      <header className="w-full bg-white shadow-md py-4 px-4">
        <h1 className="text-xl font-bold text-center text-gray-800">Módulo de Reportería</h1>
      </header>
      <main className="flex-grow p-4">
        <div className="text-center">
          <h2 className="text-lg font-semibold text-gray-700 mb-2">Generar reportes administrativos</h2>
          <p className="text-gray-600">Aquí puedes generar reportes detallados del sistema.</p>
        </div>
      </main>
      <nav className="bg-white border-t border-gray-300">
        <div className="flex justify-around py-2">
          ...
          <button onClick={() => navigate('/reporte')} className="flex flex-col items-center text-blue-500">
...
export default ModuloReporteria;
