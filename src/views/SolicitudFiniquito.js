...
const SolicitudFiniquito = () => {
  const navigate = useNavigate();

  return (
    <div className="flex flex-col h-screen bg-gray-200">
      <header className="w-full bg-white shadow-md py-4 px-4">
        <h1 className="text-xl font-bold text-center text-gray-800">Solicitud de Finiquito</h1>
      </header>
      <main className="flex-grow p-4">
        <div className="text-center">
          <h2 className="text-lg font-semibold text-gray-700 mb-2">Generar solicitud de finiquito</h2>
          <p className="text-gray-600">Aquí puedes generar la carta de finiquito cuando termines tu préstamo.</p>
        </div>
      </main>
      <nav className="bg-white border-t border-gray-300">
        <div className="flex justify-around py-2">
          ...
          <button onClick={() => navigate('/ingreso-comprobante')} className="flex flex-col items-center text-gray-700 hover:text-blue-500">
          ...
          <button onClick={() => navigate('/finiquito')} className="flex flex-col items-center text-blue-500">
...
export default SolicitudFiniquito;
