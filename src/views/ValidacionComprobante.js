  ...
  return (
    <div className="flex flex-col h-screen bg-gray-200">
      <header className="w-full bg-white shadow-md py-4 px-4">
        <h1 className="text-xl font-bold text-center text-gray-800">Validación de Comprobante</h1>
      </header>
      <main className="flex-grow p-4">
        <div className="text-center">
          <h2 className="text-lg font-semibold text-gray-700 mb-2">Validar un comprobante de pago</h2>
          <p className="text-gray-600">Aquí puedes revisar los comprobantes cargados por los clientes.</p>
        </div>
      </main>
      <nav className="bg-white border-t border-gray-300">
        <div className="flex justify-around py-2">
          ...
          <button onClick={() => navigate('/validacion-comprobante')} className="flex flex-col items-center text-blue-500">
...
export default ValidacionComprobante;
